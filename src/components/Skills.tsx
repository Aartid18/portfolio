      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-base text-slate-300 mt-3 max-w-xl mx-auto font-normal">
            Practical competencies across full-stack engineering and machine learning model development.
          </p>
        ...
        >
          {SKILL_CATEGORIES.map((category) => (
            <motion.div
              ...
              className="glass-panel p-7 rounded-3xl glow-card border-slate-700/80 shadow-xl flex flex-col justify-between"
            >
              <div>
